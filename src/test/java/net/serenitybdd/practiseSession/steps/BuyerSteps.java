...
import net.serenitybdd.practiseSession.pages.HomePage;
import net.serenitybdd.practiseSession.pages.ItemDetailsPage;
//import net.serenitybdd.practiseSession.pages.HomePage;
//import net.serenitybdd.practiseSession.pages.ItemDetailsPage;
import net.serenitybdd.practiseSession.pages.SearchResultsPage;
...
public class BuyerSteps {
	...
	// end::filterByType[]
	    ...
	    public void should_see_items_of_type(String type) {
	    	//String selectedType=searchResultsPage.getSelectedVarietytype(type);
